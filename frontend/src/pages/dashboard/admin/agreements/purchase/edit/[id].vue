...
const calculate = () => {
    ...
    if(iva_id.value === 2)
        iva_purchase_amount.value = ((Number(value) || 0) * 0.20)
    else
...
async function fetchData() {
    ...
    if(Number(route.params.id) && route.name === 'dashboard-admin-agreements-purchase-edit-id') {
        ...
        payment_type_id.value = agreement.value.payment_type_id === null && agreement.value.payment_type !== null ? 0 : agreement.value.payment_type_id
...
const goToAgreements = () => {
  ...
  let data = {
      message: 'Inköpsavtal har uppdaterats korrekt',
      error: false
  }
...
const onSubmit = async (forceSave = false) => {
    ...
    const shouldSubmitAll = forceSave === true || Number(currentTab.value) === 3
                    ...
                    <div class="d-flex mb-4" :class="windowWidth < 1024 ? 'w-100 gap-2' : 'gap-4'">
                        ...
                        <VBtn 
                            ...
                            :class="[
                                ...
                                currentTab !== 3 ? 'btn-light' : 'btn-gradient'
                            ]"
                            @click="onSubmit()"
                        >
