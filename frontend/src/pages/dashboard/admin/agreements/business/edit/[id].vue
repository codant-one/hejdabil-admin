              ...
              <VRow class="px-md-5">
                <VCol cols="12" :class="windowWidth < 1024 ? '' : 'px-0'">
                  ...
                  >
                    ...
                    <div :style="windowWidth < 1024 ? 'width: 100%;' : 'width: calc(50% - 12px);'">
                      <VLabel class="mb-1 text-body-2 text-high-emphasis" text="Erbjudandenummer" />
                      <VTextField
                        v-model="offer_id"
                        readonly
                        disabled
                    ...
                    <div :style="windowWidth < 1024 ? 'width: 100%;' : 'width: calc(50% - 12px);'">
                      <VLabel class="mb-1 text-body-2 text-high-emphasis" :text="'Bellop ' + (currencies.find(item => item.id === currency_id)?.code || '') + '*'" />
                      <VTextField
                        v-model="price"
                        type="number"
                        min="0"
