...
async function fetchData() {
    ...
    if(Number(route.params.id) && route.name === 'dashboard-admin-agreements-mediation-edit-id') {
        ...
        last_dist_belt.value = agreement.value.commission.vehicle.last_dist_belt
        last_dist_belt_date.value = agreement.value.commission.vehicle.last_dist_belt_date
...
const zeroToThirtyNumericRules = [numericRangeValidator({ min: 0, max: 30 })]
...
const onSubmit = async (forceSave = false) => {
    ...
    const shouldSubmitAll = forceSave === true || Number(currentTab.value) === 5
    ...
    if (!shouldSubmitAll && currentTab.value === 4) {
        if (hasTab4Errors) {
            await nextTick()
            refForm.value?.validate()
...
const currentData = computed(() => ({
    ...
    // Tab 1: Vehículo (Fordonsinformation)
    ...
    // Tab 2: Comisión (Förmedlingsavgift)
    commission_id: commission_id.value,
                                    ...
                                    >
                                        ...
                                        <div :style="windowWidth < 1024 ? 'width: 100%;' : 'width: calc(50% - 12px);'">
                                            ...
                                            <VTextField
                                                ...
                                                suffix="KR"
                                                :rules="[requiredValidator, ...nonNegativeNumericRules]"
                                                @input="commission_fee = normalizeNumericTextInput(commission_fee)"
                                                @keydown="handlePhoneKeydown"
                                            />
                                        </div>                                        
                                        <div :style="windowWidth < 1024 ? 'width: 100%;' : 'width: calc(50% - 12px);'">
                                            ...
                                            <VTextField
                                                ...
                                                suffix="KR"
                                                :rules="[requiredValidator, ...nonNegativeNumericRules]"
                                                @input="selling_price = normalizeNumericTextInput(selling_price)"
                                                @keydown="handlePhoneKeydown"
                                            />
                                        </div>
                                        <div :style="windowWidth < 1024 ? 'width: 100%;' : 'width: calc(50% - 12px);'">
                                        ...
                                        <div v-if="outstanding_debt === 0" :style="windowWidth < 1024 ? 'width: 100%;' : 'width: calc(50% - 12px);'">
                                            ...
                                            <VTextField
                                                ...
                                                suffix="KR"
                                                :rules="[requiredValidator, ...nonNegativeNumericRules]"
                                                @input="remaining_debt = normalizeNumericTextInput(remaining_debt)"
                                                @keydown="handlePhoneKeydown"
                                            />
                                        </div>
                                        <div v-if="outstanding_debt === 0" :style="windowWidth < 1024 ? 'width: 100%;' : 'width: calc(50% - 12px);'">
                                    ...
                                    >                                         
                                        ...
                                        <div :style="windowWidth < 1024 ? 'width: 100%;' : 'width: calc(50% - 12px);'">
                                            ...
                                            <VTextField
                                                ...
                                                v-bind="numericTextFieldProps"
                                                :rules="[requiredValidator, ...zeroToThirtyNumericRules]"
                                                @input="payment_days = normalizeNumericTextInput(payment_days)"
                                                @keydown="handlePhoneKeydown"
                                            />
                                        </div>                                            
                    ...
                    <div class="d-flex mb-4" :class="windowWidth < 1024 ? 'w-100 gap-2' : 'gap-4'">
                        ...
                        <VBtn 
                            ...
                            :class="[
                                ...
                                currentTab !== 5 ? 'btn-light' : 'btn-gradient'
                            ]"
                            @click="onSubmit()"
                        >
