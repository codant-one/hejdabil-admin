...
<head>
    ...
    <style>
        ...
        .header-title-cell h1, .header-logo-cell h1 {
            margin: 0 0 6px 0;
            font-size: 24px;
            color: {{ $company->primary_color ?? '#454545' }} !important;
        }
        ...
        .column-cell-left { padding-right: 4px !important; }
        .column-cell-right { padding-left: 4px !important; }
...
<body>
    ...
    <table class="main-container">
        <tbody>
            ...
            <tr>
                <td class="column-cell card-classic">
                    <h2>Förberedd av</h2>
                    <table class="info-table">
                        <tr>
                            ...
                            <td class="column-cell column-cell-right pb-0">
            ...
            <tr>
                <td colspan="2" class="section-cell">
                    @if($agreement->offer->comment)
                        <h2>Anmärkning</h2>
                        <div class="notes-box">
                            <div class="notes-text">{{ $agreement->offer->comment }}</div>
                        </div>
                    @endif
                    ...
                    @if($agreement->offer->terms_other_conditions)
                        ...
                        <div class="notes-box">
                            <div class="notes-text">{!! nl2br(e($agreement->offer->terms_other_conditions)) !!}</div>
                        </div>
                    @endif
                </td>
            </tr>
