...
<body>
    ...
    <table class="main-container">
        <tbody>
                    ...
                    <table class="info-table">
                        ...
                        <tr>
                            ...
                            <td class="column-cell column-cell-right-2">
                                <div class="label">Telefon</div>
                                <div class="value">
                                    {{ $agreement->agreement_client->phone ?? $agreement->agreement_client->landline }}
                                </div>
                            </td>
                        </tr>
                        <tr>
            ...
            <!-- === PAYMENT INFORMATION === -->
            @if(!is_null($agreement->vehicle_interchange))
            <tr class="page-break page-top-spacer">
                <td colspan="2" class="page-top-spacer-cell">&nbsp;</td>
            </tr>
            @endif
            <tr>
                <td colspan="2" class="card-classic">
            ...
            @endif
            <tr>
                <td colspan="2" class="section-cell card-classic">
                    ...
                    <table class="financials-table">
                        ...
                        <tfoot>
                            ...
                            <tr class="moms-row">
                                <td style="border: none;">Varav moms (25%)</td>
                                <td style="border: none;">{{ formatCurrency($agreement->iva_sale_amount) }} kr</td>
                            </tr>
                        </tfoot>
                    </table>
                </td>
            ...
            <tr>
                <td colspan="2" class="section-cell" style="padding-top: {{ is_null($agreement->vehicle_interchange) ? '180px' : '4px' }};">
                    <h2>Villkor</h2>
                </td>
            </tr>
            @endif
