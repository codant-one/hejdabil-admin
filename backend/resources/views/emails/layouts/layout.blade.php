    ...
    <body>
        <div dir="ltr" class="es-wrapper-color" lang="und">
            <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                    <td valign="top">
                        <table class="es-header" cellspacing="0" cellpadding="0" align="center"></table>
                        <table class="es-content" cellspacing="0" cellpadding="0" align="center">
                            <tr>
                                <td align="center">
                                    <table class="es-content-body" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center">
                                        <tr>
                                            <td class="es-p20t es-p20r es-p20l" bgcolor="#E5E4E3" style="padding-top: 400px; background-color: #e5e4e3; margin: auto; background-image: url('https://hejdabil.se/wp-content/uploads/2023/11/header-mailing-logo.png'); background-position: center top; background-size: 100%; background-repeat: no-repeat;" > 
                                                @yield("content")
                                            </td>
                                        </tr>
