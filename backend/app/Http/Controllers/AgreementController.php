        ...
        try {
            ...
            return DB::transaction(function () use ($request) {
                ...
                SupplierActivity::createActivity([
                    ...
                    'title' => $this->agreementActivityTitle($agreement, 'skapad'),
        ...
        try {
            ...
            return DB::transaction(function () use ($request, $agreement, $oldValues) {
                ...
                SupplierActivity::createActivity([
                    ...
                    'title' => $this->agreementActivityTitle($agreement, 'uppdaterad'),
    ...
    public function destroy($id)
    {
        try {
            ...
            SupplierActivity::createActivity([
                ...
                'title' => $this->agreementActivityTitle($agreement, 'raderad'),
                'description' => 'Ett avtal har raderats.',
                'icon' => 'custom-contract',
                'metadata' => json_encode([
                    'agreement_id' => $agreement->id,
                    'old_values' => $oldValues
    ...
    public function sendMails(Request $request, $id)
    {
        try {
            ...
            SupplierActivity::createActivity([
                ...
                'title' => $this->agreementActivityTitle($agreement, 'skickad'),
                'description' => 'Ett avtal har skickats via e-post.',
                'icon' => 'custom-contract',
                'route' => $this->agreementActivityRoute($agreement->id),
                'metadata' => json_encode([
                    'agreement_id' => $agreement->id,
