    ...
    public function store(NoteRequest $request)
    {
        try {
            ...
            SupplierActivity::createActivity([
                ...
                'description' => 'En ny vardering har skapats.',
                'icon' => 'custom-cash',
    ...
    public function update(NoteRequest $request, $id): JsonResponse
    {
        try {
            ...
            SupplierActivity::createActivity([
                ...
                'description' => 'En vardering har uppdaterats.',
                'icon' => 'custom-cash',
                'route' => '/dashboard/admin/notes',
                'metadata' => json_encode([
                    'note_id' => $note->id,
    ...
    public function destroy($id)
    {
        try {
            ...
            SupplierActivity::createActivity([
                ...
                'description' => 'En vardering har tagits bort.',
                'icon' => 'custom-cash',
                'metadata' => json_encode([
                    'note_id' => $note->id,
                    'old_values' => $oldValues,
    ...
    public function comment(Request $request)
    {
        try {
            ...
            SupplierActivity::createActivity([
                ...
                'title' => $this->noteActivityTitle($note, 'kommentar skickad'),
                'description' => 'En kommentar har skickats till en vardering.',
                'icon' => 'custom-cash',
                'route' => '/dashboard/admin/notes',
                'metadata' => json_encode([
                    'note_id' => $note->id,
    ...
    public function updateComment(Request $request, $id)
    {
        try {
            ...
            SupplierActivity::createActivity([
                ...
                'description' => 'En kommentar har uppdaterats pa en vardering.',
                'icon' => 'custom-cash',
                'route' => '/dashboard/admin/notes',
                'metadata' => json_encode([
                    'note_id' => $note->id,
    ...
    public function deleteComment(Request $request, $id)
    {
        try {
            ...
            SupplierActivity::createActivity([
                ...
                'description' => 'En kommentar har tagits bort fran en vardering.',
                'icon' => 'custom-cash',
                'route' => '/dashboard/admin/notes',
                'metadata' => json_encode([
                    'note_id' => $note->id,
